				...
				<section class="floater">
					<transition name="slide-slow" mode="out-in">
						<section :key="featuredApp.applink">
							...
							<Button @click.native="openInBrowser(featuredApp.url)" primary="1" :text="`Open ${featuredApp.name}`" :forced-styles="featuredApp.colors ? featuredApp.colors.button : null" />
						</section>
					</transition>
